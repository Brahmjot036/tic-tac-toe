  ...
  return (
    <div className='bg-heroBg flex items-center justify-center py-28 px-8' id='contact'>
      <div className='container mx-auto'>
        <div className='md:w-4/5 mx-auto grid grid-cols-2 md:grid-cols-2 items-center md:gap-12 gap-8'>
        {/* left side */}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 text-white'>
                <div className='flex items-start gap-4'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p>Mental wellness doesn’t follow a 9-to-5 schedule, and neither do we. Access our resources, tools, and support anytime you need them.</p>
                    </div>
                </div>
                <div className='flex items-start gap-4'>
                    <div className='flex items-center justify-center rounded-full bg-[#ffffff1a] p-3'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p>Work with highly qualified and experienced therapists who specialize in a range of mental health areas to provide you with the best care.</p>
                    </div>
                </div>
                <div className='flex items-start gap-4'>
                    <div className='flex items-center justify-center rounded-full bg-[#ffffff1a] p-3'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p>Our platform is designed to deliver personalized and effective solutions, ensuring the highest standards of mental wellness support.</p>
                    </div>
                </div>
                <div className='flex items-start gap-4'>
                    <div className='flex items-center justify-center rounded-full bg-[#ffffff1a] p-3'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p>MindLeep is a safe and reliable platform trusted by individuals seeking genuine and impactful mental health services.</p>
                    </div>
                </div>
            </div>
        </div>
